...
class MaeParticipantes(models.Model):
    ...
    idtipodoc = models.ForeignKey(MaeTipodocumento, db_column='idtipodoc', on_delete=models.CASCADE)
    iduniversidad = models.ForeignKey(MaeUniversidad, db_column='iduniversidad', on_delete=models.CASCADE)
    idtipo = models.ForeignKey(MaeTipoParticipante, db_column='idtipo', on_delete=models.CASCADE)
